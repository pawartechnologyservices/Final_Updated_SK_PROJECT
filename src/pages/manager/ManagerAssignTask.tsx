    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">View and manage tasks assigned to you or created by you</p>
        </div>
        <div className="flex items-center gap-3">
          <Button onClick={() => setShowAssignPopup(true)} size="lg" className="bg-primary">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-4">
              ...
              <TabsTrigger value="completed">
                Completed
                {completedCount > 0 && <Badge variant="secondary" className="ml-2">{completedCount}</Badge>}
              </TabsTrigger>
            </TabsList>
          </Tabs>
        </CardHeader>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Supervisor Progress</TableHead>
